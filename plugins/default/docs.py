if answ[1] == 'доки':
	...
	if (res['response']['count'] != 0):
		...
		for item in res['response']['items']:
			if fcount == 10:
				break
			if item['id'] in (474084484,444393573,337586976,467187768,170067184,170126360,457132116,453208914,464271002,474084484,463015737,11290494,329510426,122229518,459118885):
				continue
