if answ[1] == 'видео':
		...
		if (res['response']['count'] != 0):
			for item in res['response']['items']:
				if item['id'] in (170754590,170631958,170067184,168063882,160911967,140239214,1609119666,166873080,166873080,166873080,166873080,166873080,166873080,166873080,160973038,166088674,166159461,456239165,159490950,169336720,169712331,169875157,159555698):
					continue
